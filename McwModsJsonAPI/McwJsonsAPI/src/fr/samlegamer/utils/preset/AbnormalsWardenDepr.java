...
@Deprecated
public class AbnormalsWardenDepr implements Presetting
{
	...
	public AbnormalsWardenDepr()
	{
		this(true, true, true, true, true, true, true, true, true, ModLoaders.FORGE);
	}
	
	public AbnormalsWardenDepr(boolean activeBridges, boolean activeRoofs, boolean activeFences, boolean activeFurnitures, boolean activeStairs, boolean activePaths, boolean activeDoors, boolean activeTraps,
	...
	public void init(String LOCATION)
	{
		...
		if(activeBridges)
		{
			...
			ModsList.abnormalsWood(MAT_WOOD, Compatibilities.CAVERNCHASMS_MODID);
		...
		ModsList.abnormalsWood119(MAT_WOOD);
		ModsList.abnormalsRock(MAT_ROCK);
		ModsList.abnormalsLeaves(LEAVES);
		English.Abnormals.abnormalsWood119Lang(MAJ_WOOD);
		...
		MAJ_ROCK.clear();
		MAJ_LEAVES.clear();
		French.Abnormals.abnormalsWood119Lang(MAJ_WOOD);
