...
public class ModdingLegacy implements Presetting
{
	...
	private final boolean SupNether;
	private final ModLoaders modLoader;

	public ModdingLegacy(boolean bridges, boolean roofs, boolean fences, boolean furnitures, boolean stairs, boolean traps, boolean doors, boolean paths, boolean windows, boolean SupNether, ModLoaders modLoader)
	{
	...
	{
		this(true, true, true, true, true, true, true, true, true, SupNether, ModLoaders.FORGE);
	}
	...
	public void init(String LOCATION)
	{
		...
		NewModsList.ModdingLegacy.BlueSkiesTextures(ID_WOOD);
...
//		French.ModdingLegacy.BlueSkiesLang(LANG_WOOD);
//		French.ModdingLegacy.PremiumWoodLang(LANG_WOOD);
//		PREFIX_ID_WOOD.add("bsky_crystallized");
//		LANG_WOOD.add("cristallisé");

		//bridges_tags.AxeDataGenWood(LOCATION, CompatModid, PREFIX_ID_WOOD);
		//bridges_tags.TagsWood(LOCATION, CompatModid, PREFIX_ID_WOOD);
		//roofs_tags.AxeDataGenWood(LOCATION, CompatModid, PREFIX_ID_WOOD);
		
//		bridges_lang.initAllWoodFrench(CompatModid, PREFIX_ID_WOOD, LANG_WOOD);
//		roofs_lang.initAllWoodFrench(CompatModid, PREFIX_ID_WOOD, LANG_WOOD);
//		PREFIX_ID_WOOD.clear();
//		LANG_WOOD.clear();
...
//		PREFIX_ID_LEAVE.addAll(PREFIX_ID_WOOD);
//		PREFIX_ID_LEAVE.add("bsky_crystallized");
//		LANG_LEAVE.add("cristallisé");

		//fences_tags.AxeDataGenWood(LOCATION, CompatModid, PREFIX_ID_WOOD);
		//fences_tags.HoeDataGenWood(LOCATION, CompatModid, PREFIX_ID_LEAVE);
		//fences_tags.TagsWood(LOCATION, CompatModid, PREFIX_ID_WOOD);
//		fences_lang.initAllWoodFrench(CompatModid, PREFIX_ID_WOOD, LANG_WOOD);
		
		//furni_tags.AxeDataGenWood(LOCATION, CompatModid, PREFIX_ID_WOOD);
		//furni_tags.TagsWood(LOCATION, CompatModid, PREFIX_ID_WOOD);
//		furni_lang.initAllWoodFrench(CompatModid, PREFIX_ID_WOOD, LANG_WOOD);
//		stairs_lang.initAllWoodFrench(CompatModid, PREFIX_ID_WOOD, LANG_WOOD);
//		paths_lang.initAllWoodFrench(CompatModid, PREFIX_ID_WOOD, LANG_WOOD);
//		doors_lang.initAllWoodFrench(CompatModid, PREFIX_ID_WOOD, LANG_WOOD);
//		traps_lang.initAllWoodFrench(CompatModid, PREFIX_ID_WOOD, LANG_WOOD);
//		wins_lang.initAllWoodFrench(CompatModid, PREFIX_ID_WOOD, LANG_WOOD);
	...
	List<String> LANG_LEAVE, String language, String cristalized)
	{
		...
		NewModsList.ModdingLegacy.BlueSkiesBsky(PREFIX_ID_WOOD);
		NewModsList.ModdingLegacy.PremiumWoodPwood(PREFIX_ID_WOOD);
		LangMods.ModdingLegacy.blueSkiesWoodLang(LANG_WOOD, language);
	...
	public void genPwoodWood(String LOCATION, String CompatModid, String txtLocMod, List<String> ID_WOOD, List<String> PREFIX_ID_WOOD, List<String> ID_LEAVE, List<String> PREFIX_ID_LEAVE, String ModidOfBaseMod, String folderWood)
	{
		...
		{
			client_wood_bridges.createWoodBlockstates(LOCATION, CompatModid, PREFIX_ID_WOOD);
			client_wood_bridges.createWoodModelsBlocksPrefixed(LOCATION, txtLocMod+"/"+folderWood, ID_WOOD, PREFIX_ID_WOOD, false);
			client_wood_bridges.createWoodModelItem(LOCATION, CompatModid, PREFIX_ID_WOOD);
			...
			data_bridges.LootTableLogAll(LOCATION, CompatModid, PREFIX_ID_WOOD);
			data_bridges.RecipesLogAllPrefixedIsCharged(LOCATION, CompatModid, ModidOfBaseMod, ID_WOOD, PREFIX_ID_WOOD, false, Compatibilities.MCW_BRIDGES_MODID, ModidOfBaseMod, false, modLoader);
		}
		
		if(roofs)
		{
			client_wood_roofs.createWoodBlockstates(LOCATION, CompatModid, PREFIX_ID_WOOD);
			client_wood_roofs.createWoodModelsBlocksPrefixed(LOCATION, txtLocMod+"/"+folderWood, ID_WOOD, PREFIX_ID_WOOD, false);
			client_wood_roofs.createWoodModelItem(LOCATION, CompatModid, PREFIX_ID_WOOD);
			...
			data_roofs.LootTableLogAll(LOCATION, CompatModid, PREFIX_ID_WOOD);
			data_roofs.RecipesLogAllPrefixedIsCharged(LOCATION, CompatModid, ModidOfBaseMod, ID_WOOD, PREFIX_ID_WOOD, false, Compatibilities.MCW_ROOFS_MODID, ModidOfBaseMod, false, modLoader);
		}
		
		if(fences)
		{
			client_wood_fences.createWoodBlockstates(LOCATION, CompatModid, PREFIX_ID_WOOD);
			client_wood_fences.createWoodModelsBlocksPrefixed(LOCATION, txtLocMod+"/"+folderWood, ID_WOOD, PREFIX_ID_WOOD, false);
			client_wood_fences.createWoodModelItem(LOCATION, CompatModid, PREFIX_ID_WOOD);
			...
			data_fences.LootTableLogAll(LOCATION, CompatModid, PREFIX_ID_WOOD);
			data_fences.RecipesLogAllPrefixedIsCharged(LOCATION, CompatModid, ModidOfBaseMod, ID_WOOD, PREFIX_ID_WOOD, false, Compatibilities.MCW_FENCES_MODID, ModidOfBaseMod, false, modLoader);
		}
		
		if(furnitures)
		{
			client_wood_furnitures.createWoodBlockstates(LOCATION, CompatModid, PREFIX_ID_WOOD);
			client_wood_furnitures.createWoodModelsBlocksPrefixed(LOCATION, txtLocMod+"/"+folderWood, ID_WOOD, PREFIX_ID_WOOD, false);
			client_wood_furnitures.createWoodModelItem(LOCATION, CompatModid, PREFIX_ID_WOOD);
			...
			data_furnitures.LootTableLogAll(LOCATION, CompatModid, PREFIX_ID_WOOD);
			data_furnitures.RecipesLogAllPrefixedIsCharged(LOCATION, CompatModid, ModidOfBaseMod, ID_WOOD, PREFIX_ID_WOOD, false, Compatibilities.MCW_FURNITURES_MODID, ModidOfBaseMod, false, modLoader);
		}
		
		if(fences)
		{
			client_wood_fences.createWoodBlockstateswithResearch(LOCATION, CompatModid, PREFIX_ID_LEAVE, "acacia_hedge");
			client_wood_fences.createWoodModelsBlockswithResearchPrefixed(LOCATION, txtLocMod+"/"+folderWood, ID_LEAVE, PREFIX_ID_LEAVE, Boolean.FALSE, "acacia_wall");
		...
		{
			client_wood_stairs.createWoodBlockstates(LOCATION, CompatModid, PREFIX_ID_WOOD);
			client_wood_stairs.createWoodModelsBlocksPrefixed(LOCATION, txtLocMod+"/"+folderWood, ID_WOOD, PREFIX_ID_WOOD, false);
			client_wood_stairs.createWoodModelItem(LOCATION, CompatModid, PREFIX_ID_WOOD);
			...
			data_stairs.LootTableLogAll(LOCATION, CompatModid, PREFIX_ID_WOOD);
			data_stairs.RecipesLogAllPrefixedIsCharged(LOCATION, CompatModid, ModidOfBaseMod, ID_WOOD, PREFIX_ID_WOOD, false, Compatibilities.MCW_STAIRS_MODID, ModidOfBaseMod, false, modLoader);
		}
		...
		if(paths)
		{
			...
			client_wood_paths.createWoodModelsBlocksPrefixed(LOCATION, txtLocMod+"/"+folderWood, ID_WOOD, PREFIX_ID_WOOD, false);
			...
			data_paths.RecipesLogAllPrefixedIsCharged(LOCATION, CompatModid, ModidOfBaseMod, ID_WOOD, PREFIX_ID_WOOD, false, Compatibilities.MCW_PATHS_MODID, ModidOfBaseMod, false, modLoader);
		}
		...
		if(doors)
		{
			...
			client_wood_doors.createWoodModelsBlocksPrefixed(LOCATION, txtLocMod+"/"+folderWood, ID_WOOD, PREFIX_ID_WOOD, false);
			...
			data_doors.RecipesLogAllPrefixedIsCharged(LOCATION, CompatModid, ModidOfBaseMod, ID_WOOD, PREFIX_ID_WOOD, false, Compatibilities.MCW_DOORS_MODID, ModidOfBaseMod, false, modLoader);
		}
		...
		if(traps)
		{
			...
			client_wood_traps.createWoodModelsBlocksPrefixed(LOCATION, txtLocMod+"/"+folderWood, ID_WOOD, PREFIX_ID_WOOD, false);
			...
			data_traps.RecipesLogAllPrefixedIsCharged(LOCATION, CompatModid, ModidOfBaseMod, ID_WOOD, PREFIX_ID_WOOD, false, Compatibilities.MCW_TRAPDOORS_MODID, ModidOfBaseMod, false, modLoader);
		}
		...
		if(windows)
		{
			...
			client_wood_windows.createWoodModelsBlocksPrefixed(LOCATION, txtLocMod+"/"+folderWood, ID_WOOD, PREFIX_ID_WOOD, false);
			...
			data_windows.RecipesLogAllPrefixedIsCharged(LOCATION, CompatModid, ModidOfBaseMod, ID_WOOD, PREFIX_ID_WOOD, false, Compatibilities.MCW_WINDOWS_MODID, ModidOfBaseMod, false, modLoader);
		}
	}
}