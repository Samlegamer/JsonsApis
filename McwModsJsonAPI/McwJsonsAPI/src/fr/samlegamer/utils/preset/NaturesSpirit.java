...
public class NaturesSpirit implements Presetting
{
    ...
    public NaturesSpirit(String versioning, ModLoaders modLoader, Versions version)
    {
    ...
    public NaturesSpirit(ModLoaders modL, Versions version)
    {
        this("1.20", modL, version);
    }

    public NaturesSpirit(ModLoaders modL)
    {
    ...
    public void init(String LOCATION)
    {
        ...
        NewModsList.NaturesSpirit.naturesSpiritWood(ID_WOOD, version);
        NewModsList.NaturesSpirit.naturesSpiritLeave(ID_LEAVE, version);

        String TextureLocationFormodid = Compatibilities.NATURES_SPIRIT_TEXTURES;
        String ModidOfBaseMod = Compatibilities.NATURES_SPIRIT_MODID;
        String CompatModid = "mcwnaturesspirit";
...
//        }
    ...
    private void addLanguage(String LOCATION, String CompatModid, List<String> ID_WOOD, List<String> LANG_WOOD, List<String> ID_LEAVE, List<String> LANG_LEAVE, String language)
    {
        ...
        LangMods.NaturesSpirit.naturesSpiritWoodLang(LANG_WOOD, language, version);
        LangMods.NaturesSpirit.naturesSpiritLeaveLang(LANG_LEAVE, language, version);
