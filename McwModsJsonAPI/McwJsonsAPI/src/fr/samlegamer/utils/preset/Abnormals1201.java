...
public class Abnormals1201 implements Presetting
{
	...
	public Abnormals1201(boolean activeBridges, boolean activeRoofs, boolean activeFences, boolean activeFurnitures, boolean activeStairs, boolean activePaths, boolean activeDoors, boolean activeTraps, 
	...
	{
		res.createWoodBlockstates(LOCATION, CompatModid, MAT_WOOD);
		res.createWoodCustomModelsBlocks(LOCATION, txtLocMod, MAT_WOOD, "poise_planks", "poise_stem", "stripped_poise_stem");
		res.createWoodModelItem(LOCATION, CompatModid, MAT_WOOD);
