...
public class Abnormals implements Presetting
{
	...
	public Abnormals(List<String> mcwMods, ModLoaders modLoader)
	{
...
//		}
		...
		NewModsList.Abnormals.abnormalsWood(ID_WOOD);
...
//		LANG_LEAVE.clear();
	...
	private void genTags(String LOCATION, String CompatModid, List<String> ID_WOOD, List<String> ID_LEAVE, List<String> ID_ROCK, ITagData tag)
	{
	...
	List<String> LANG_ROCK, List<String> ID_LEAVE, List<String> LANG_LEAVE, String language)
	{
		...
		LangMods.Abnormals.abnormalsWoodLang(LANG_WOOD, language);
