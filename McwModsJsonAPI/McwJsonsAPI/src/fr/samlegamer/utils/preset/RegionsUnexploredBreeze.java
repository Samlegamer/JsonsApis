...
public class RegionsUnexploredBreeze implements Presetting
{
    ...
    public RegionsUnexploredBreeze(String versioning, ModLoaders modLoader)
    {
        this.versioning = versioning;
        this.modLoader = modLoader;
    }

    public RegionsUnexploredBreeze(ModLoaders modL)
    {
        this("1.21", modL);
    }
    ...
    public void init(String LOCATION)
    {
        ...
        NewModsList.RegionsUnexplored.regionsUnexploredWoodBreeze(ID_WOOD);
        NewModsList.RegionsUnexplored.regionsUnexploredLeaveBreeze(ID_LEAVE);
        ...
        NewModsList.RegionsUnexplored.regionsUnexploredWoodBreeze(ID_WOOD, true);
        ...
        JsonsUtils.replacer(LOCATION + File.separator + McwAPI.ClassicFolderTypes.MODEL_BLOCK.getPath() + "hedges" + File.separator, "flowering", "flowering_leaves", "flowering_leaves_flower");

        JsonsUtils.replacer(LOCATION + File.separator + McwAPI.ClassicFolderTypes.MODEL_BLOCK.getPath() + "hedges" + File.separator, "salmon_wisteria", "salmon_wisteria_leaves", "wisteria_leaves");
        JsonsUtils.replacer(LOCATION + File.separator + McwAPI.ClassicFolderTypes.MODEL_BLOCK.getPath() + "hedges" + File.separator, "lavender_wisteria", "lavender_wisteria_leaves", "wisteria_leaves");
        JsonsUtils.replacer(LOCATION + File.separator + McwAPI.ClassicFolderTypes.MODEL_BLOCK.getPath() + "hedges" + File.separator, "sky_wisteria", "sky_wisteria_leaves", "wisteria_leaves");
    ...
    private void addLanguage(String LOCATION, String CompatModid, String language)
    {
        ...
        LangMods.RegionsUnexplored.regionsUnexploredWoodBreezeLang(LANG_WOOD, language);
        LangMods.RegionsUnexplored.regionsUnexploredLeaveBreezeLang(LANG_LEAVE, language);
