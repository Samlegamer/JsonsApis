...
public class MFRecipesGenerator
{
	...
	public static class PyramidGate
	{
		public static void loot_tables(String location, String ModidCompat, String material)
		{
			File file = new File(location + "/data/loot_tables/blocks/" + material + "_pyramid_gate" + ".json");
			...
			APIWriter.write(location, file, "{\r\n"
					...
					+ "        {\r\n"
					+ "          \"type\": \"minecraft:item\",\r\n"
					+ "          \"name\": \""+ModidCompat+":"+material+"_pyramid_gate\"\r\n"
					+ "        }\r\n"
					+ "      ],\r\n"
					+ "      \"conditions\": [\r\n"
					+ "        {\r\n"
		...
		public static void recipe(String location, String modidExtended, String ModidCompat, String material, boolean isStemTexture)
		{
			File file = new File(location + "/data/recipes/" + material + "_pyramid_gate" + ".json");
			...
			APIWriter.write(location, file, "{\r\n"
					...
					+ "    \"result\":\r\n"
					+ "    {\r\n"
					+ "        \"item\":  \""+ModidCompat+":"+material+"_pyramid_gate\",\r\n"
					+ "        \"count\": 1\r\n"
					+ "    }\r\n"
					+ "}");					
		}
