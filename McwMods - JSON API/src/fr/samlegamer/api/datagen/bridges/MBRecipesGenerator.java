...
public class MBRecipesGenerator
{
	...
	public static class BridgeLog
	{
		...
		{
			File file = new File(location + "/data/loot_tables/blocks/" + material + "_log_bridge_middle" + ".json");
	...
	public static class BridgeStone
	{
		...
		public static void loot_tablesGen(String location, String modidCompat, String material)
		{
			File file = new File(location + "/data/loot_tables/blocks/" + material + "_bridge" + ".json");
	...
	public static class RopeBridge
	{
		...
		public static void loot_tablesGen(String location, String modidCompat, String material)
		{
			File file = new File(location + "/data/loot_tables/blocks/" + "rope_" + material + "_bridge" + ".json");
	...
	{
		public static void recipeGenWood(String location, String modid, String modidCompat, String material, boolean stone, boolean isStemTexture)
		{
		...
		public static void recipeGenStone(String location, String modid, String modidCompat, String material)
		{
			File file = new File(location + "/data/recipes/" + material + "_bridge_pier" + ".json");
		...
		public static void loot_tablesGen(String location, String modidCompat, String material)
		{
			File file = new File(location + "/data/loot_tables/blocks/" + material + "_bridge_pier" + ".json");
	...
	{
		public static void recipeGenWood(String location, String modidCompat, String material, boolean stone)
		{
		...
		public static void recipeGenStone(String location, String modidCompat, String material)
		{
			File file = new File(location + "/data/recipes/" + material + "_bridge_stair" + ".json");
		...
		{
			File file = new File(location + "/data/loot_tables/blocks/" + material + (stone ? "_bridge_stair" : "_log_bridge_stair") + ".json");
	...
	public static class Rails
	{
		...
		public static void loot_tablesGen(String location, String modidCompat, String material)
		{
			File file = new File(location + "/data/loot_tables/blocks/" + material + "_rail_bridge" + ".json");
	...
	public static class RopeStairs
	{
		...
		public static void loot_tablesGen(String location, String modidCompat, String material)
		{
			File file = new File(location + "/data/loot_tables/blocks/" + material + "_rope_bridge_stair" + ".json");
