...
{//+ nameMaterial + (isStemTexture ? "_stem" : "_log") +
	...
	public static class HighleyGate
	{
		...
		if(!file.exists())
		{
			try
			{
				...
				buffer.write("{\"parent\": \""+modid+":block/highley_gate/"+mat+"_highley_gate\"}");
	...
	public static class PyramidGate
	{
		public static void createBlockstate(String location, String modid, String material)
		{
			File file = new File(location + "/blockstates/"+material+"_pyramid_gate" + ".json");
		...
		if(!file.exists())
		{
			try
			{
				...
				buffer.write("{\r\n"
						...
						+ "      \"uvlock\": false,\r\n"
						+ "      \"y\": 270,\r\n"
						+ "      \"model\": \""+modid+":block/pyramid_gate/"+material+"_pyramid_gate\"\r\n"
						+ "    },\r\n"
						+ "    \"facing=east,in_wall=false,open=true\": {\r\n"
						+ "      \"uvlock\": false,\r\n"
						+ "      \"y\": 270,\r\n"
						+ "      \"model\": \""+modid+":block/pyramid_gate/"+material+"_pyramid_gate_open\"\r\n"
						+ "    },\r\n"
						+ "    \"facing=east,in_wall=true,open=false\": {\r\n"
						+ "      \"uvlock\": false,\r\n"
						+ "      \"y\": 270,\r\n"
		...
		if(!p1.exists())
		{
			try
			{
				...
				buffer.write("{\"parent\":\"mcwfences:block/parent/pyramid_gate\",\r\n"
						+ "\"textures\":{\"3\": \""+TextureLocationFormodid+"/"+ nameMaterial + (isStemTexture ? "_stem" : "_log") +"\",\r\n"
						+ "\"6\": \""+TextureLocationFormodid+"/"+ nameMaterial +"_planks\",\r\n"
						+ "\"particle\": \""+TextureLocationFormodid+"/"+ nameMaterial +"_planks\"}}");
		...
		public static void createModelItem(String location, String modid, String mat)
		{
			File file = new File(location + "/models/item/" + mat + "_pyramid_gate" + ".json");
		...
		if(!file.exists())
		{
			try
			{
				...
				buffer.write("{\"parent\": \""+modid+":block/pyramid_gate/"+mat+"_pyramid_gate\"}");
