...
public class MacawsRoofs
{
		...
		public static void createModelsBlock(String Location, String TextureLocationFormodid, String material, boolean isStemTexture)
		{
			...
			if(!roof_open.exists())
			{
				try
				{
					...
					System.out.println("Le fichier " + roof_open + " Vient d'�tre g�n�rer � l'emplacement : " + Location);
				}
				catch (IOException e)
				{
					e.printStackTrace();
			...
			if(!roof_closed.exists())
			{
				try
				{
					...
					System.out.println("Le fichier " + roof_closed + " Vient d'�tre g�n�rer � l'emplacement : " + Location);
				}
				catch (IOException e)
				{
					e.printStackTrace();
		...
		public static void createModelsBlock(String Location, String TextureLocationFormodid, String material, boolean isStemTexture)
		{
			...
			if(!f1.exists())
			{
				try
				{
					...
					writer.close();
					f1.createNewFile();
					System.out.println("Le fichier " + f1 + " Vient d'�tre g�n�rer � l'emplacement : " + Location);
				}
				catch (IOException e)
				{
					e.printStackTrace();
			...
			if(!f2.exists())
			{
				try
				{
					...
					writer.close();
					f2.createNewFile();
					System.out.println("Le fichier " + f2 + " Vient d'�tre g�n�rer � l'emplacement : " + Location);
				}
				catch (IOException e)
				{
					e.printStackTrace();
			...
			if(!f3.exists())
			{
				try
				{
					...
					writer.close();
					f3.createNewFile();
					System.out.println("Le fichier " + f3 + " Vient d'�tre g�n�rer � l'emplacement : " + Location);
				}
				catch (IOException e)
				{
					e.printStackTrace();
			...
			if(!f4.exists())
			{
				try
				{
					...
					writer.close();
					f4.createNewFile();
					System.out.println("Le fichier " + f4 + " Vient d'�tre g�n�rer � l'emplacement : " + Location);
				}
				catch (IOException e)
				{
					e.printStackTrace();
			...
			if(!f5.exists())
			{
				try
				{
					...
					writer.close();
					f5.createNewFile();
					System.out.println("Le fichier " + f5 + " Vient d'�tre g�n�rer � l'emplacement : " + Location);
				}
				catch (IOException e)
				{
					e.printStackTrace();
			...
			if(!f6.exists())
			{
				try
				{
					...
					writer.close();
					f6.createNewFile();
					System.out.println("Le fichier " + f6 + " Vient d'�tre g�n�rer � l'emplacement : " + Location);
				}
				catch (IOException e)
				{
					e.printStackTrace();
	...
	public static class Log_Roof
	{
		public static void createBlockstate(String Location, String CompatModid, String material)
		{
			...
			APIWriter.write(Location, file, "{\r\n"
					+ "    \"variants\": {\r\n"
					+ "        \"facing=east,shape=straight,half=bottom\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_roof\" },\r\n"
					+ "        \"facing=west,shape=straight,half=bottom\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_roof\", \"y\": 180 },\r\n"
					+ "        \"facing=south,shape=straight,half=bottom\": { \"model\": \""+CompatModid+":block/roof/"+material+"_roof\", \"y\": 90 },\r\n"
					+ "        \"facing=north,shape=straight,half=bottom\": { \"model\": \""+CompatModid+":block/roof/"+material+"_roof\", \"y\": 270 },\r\n"
					+ "        \r\n"
					+ "        \"facing=east,shape=outer_right,half=bottom\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_outer\" },\r\n"
					+ "        \"facing=west,shape=outer_right,half=bottom\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_outer\", \"y\": 180 },\r\n"
					+ "        \"facing=south,shape=outer_right,half=bottom\": { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_outer\", \"y\": 90 },\r\n"
					+ "        \"facing=north,shape=outer_right,half=bottom\": { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_outer\", \"y\": 270 },\r\n"
					+ "        \r\n"
					+ "        \"facing=east,shape=outer_left,half=bottom\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_outer\", \"y\": 270 },\r\n"
					+ "        \"facing=west,shape=outer_left,half=bottom\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_outer\", \"y\": 90 },\r\n"
					+ "        \"facing=south,shape=outer_left,half=bottom\": { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_outer\" },\r\n"
					+ "        \"facing=north,shape=outer_left,half=bottom\": { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_outer\", \"y\": 180 },\r\n"
					+ "        \r\n"
					+ "        \"facing=east,shape=inner_right,half=bottom\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_inner\" },\r\n"
					+ "        \"facing=west,shape=inner_right,half=bottom\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_inner\", \"y\": 180 },\r\n"
					+ "        \"facing=south,shape=inner_right,half=bottom\": { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_inner\", \"y\": 90 },\r\n"
					+ "        \"facing=north,shape=inner_right,half=bottom\": { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_inner\", \"y\": 270 },\r\n"
					+ "        \r\n"
					+ "        \"facing=east,shape=inner_left,half=bottom\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_inner\", \"y\": 270 },\r\n"
					+ "        \"facing=west,shape=inner_left,half=bottom\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_inner\", \"y\": 90 },\r\n"
					+ "        \"facing=south,shape=inner_left,half=bottom\": { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_inner\" },\r\n"
					+ "        \"facing=north,shape=inner_left,half=bottom\": { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_inner\", \"y\": 180 },\r\n"
					+ "\r\n"
					+ "\r\n"
					+ "        \"facing=east,shape=straight,half=top\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_roof\", \"x\": 180 },\r\n"
					+ "        \"facing=west,shape=straight,half=top\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_roof\", \"x\": 180, \"y\": 180 },\r\n"
					+ "        \"facing=south,shape=straight,half=top\": { \"model\": \""+CompatModid+":block/roof/"+material+"_roof\", \"x\": 180, \"y\": 90 },\r\n"
					+ "        \"facing=north,shape=straight,half=top\": { \"model\": \""+CompatModid+":block/roof/"+material+"_roof\", \"x\": 180, \"y\": 270 },\r\n"
					+ "        \r\n"
					+ "        \"facing=east,shape=outer_right,half=top\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_outer\", \"x\": 180, \"y\": 90 },\r\n"
					+ "        \"facing=west,shape=outer_right,half=top\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_outer\", \"x\": 180, \"y\": 270 },\r\n"
					+ "        \"facing=south,shape=outer_right,half=top\": { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_outer\", \"x\": 180, \"y\": 180 },\r\n"
					+ "        \"facing=north,shape=outer_right,half=top\": { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_outer\", \"x\": 180, \"y\": 0 },\r\n"
					+ "        \r\n"
					+ "        \"facing=east,shape=outer_left,half=top\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_outer\", \"x\": 180, \"y\": 0 },\r\n"
					+ "        \"facing=west,shape=outer_left,half=top\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_outer\", \"x\": 180, \"y\": 180 },\r\n"
					+ "        \"facing=south,shape=outer_left,half=top\": { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_outer\", \"x\": 180, \"y\": 90 },\r\n"
					+ "        \"facing=north,shape=outer_left,half=top\": { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_outer\", \"x\": 180, \"y\": 270 },\r\n"
					+ "        \r\n"
					+ "        \"facing=east,shape=inner_right,half=top\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_inner\", \"x\": 180, \"y\": 90 },\r\n"
					+ "        \"facing=west,shape=inner_right,half=top\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_inner\", \"x\": 180, \"y\": 270 },\r\n"
					+ "        \"facing=south,shape=inner_right,half=top\": { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_inner\", \"x\": 180, \"y\": 180 },\r\n"
					+ "        \"facing=north,shape=inner_right,half=top\": { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_inner\", \"x\": 180, \"y\": 0 },\r\n"
					+ "        \r\n"
					+ "        \"facing=east,shape=inner_left,half=top\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_inner\", \"x\": 180, \"y\": 0 },\r\n"
					+ "        \"facing=west,shape=inner_left,half=top\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_inner\", \"x\": 180, \"y\": 180 },\r\n"
					+ "        \"facing=south,shape=inner_left,half=top\": { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_inner\", \"x\": 180, \"y\": 90 },\r\n"
					+ "        \"facing=north,shape=inner_left,half=top\": { \"model\": \""+CompatModid+":block/roof/"+material+"_roof_inner\", \"x\": 180, \"y\": 270 }\r\n"
					+ "    }\r\n"
					+ "}");
		}
		...
		public static void createModelsBlock(String Location, String TextureLocationFormodid, String material, boolean isStemTexture)
		{
			...
			if(!roof.exists())
			{
				try
				{
					...
					writer.close();
					roof.createNewFile();
					System.out.println("Le fichier " + roof + " Vient d'�tre g�n�rer � l'emplacement : " + Location);
				}
				catch (IOException e)
				{
					e.printStackTrace();
			...
			if(!roof_inner.exists())
			{
				try
				{
					...
					System.out.println("Le fichier " + roof_inner + " Vient d'�tre g�n�rer � l'emplacement : " + Location);
				}
				catch (IOException e)
				{
					e.printStackTrace();
			...
			if(!roof_outer.exists())
			{
				try
				{
					...
					System.out.println("Le fichier " + roof_outer + " Vient d'�tre g�n�rer � l'emplacement : " + Location);
				}
				catch (IOException e)
				{
					e.printStackTrace();
	...
	public static class Planks_Roof
	{
		public static void createBlockstate(String Location, String CompatModid, String material)
		{
			...
			APIWriter.write(Location, file, "{\r\n"
					+ "    \"variants\": {\r\n"
					+ "        \"facing=east,shape=straight,half=bottom\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof\" },\r\n"
					+ "        \"facing=west,shape=straight,half=bottom\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof\", \"y\": 180 },\r\n"
					+ "        \"facing=south,shape=straight,half=bottom\": { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof\", \"y\": 90 },\r\n"
					+ "        \"facing=north,shape=straight,half=bottom\": { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof\", \"y\": 270 },\r\n"
					+ "        \r\n"
					+ "        \"facing=east,shape=outer_right,half=bottom\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_outer\" },\r\n"
					+ "        \"facing=west,shape=outer_right,half=bottom\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_outer\", \"y\": 180 },\r\n"
					+ "        \"facing=south,shape=outer_right,half=bottom\": { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_outer\", \"y\": 90 },\r\n"
					+ "        \"facing=north,shape=outer_right,half=bottom\": { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_outer\", \"y\": 270 },\r\n"
					+ "        \r\n"
					+ "        \"facing=east,shape=outer_left,half=bottom\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_outer\", \"y\": 270 },\r\n"
					+ "        \"facing=west,shape=outer_left,half=bottom\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_outer\", \"y\": 90 },\r\n"
					+ "        \"facing=south,shape=outer_left,half=bottom\": { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_outer\" },\r\n"
					+ "        \"facing=north,shape=outer_left,half=bottom\": { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_outer\", \"y\": 180 },\r\n"
					+ "        \r\n"
					+ "        \"facing=east,shape=inner_right,half=bottom\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_inner\" },\r\n"
					+ "        \"facing=west,shape=inner_right,half=bottom\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_inner\", \"y\": 180 },\r\n"
					+ "        \"facing=south,shape=inner_right,half=bottom\": { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_inner\", \"y\": 90 },\r\n"
					+ "        \"facing=north,shape=inner_right,half=bottom\": { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_inner\", \"y\": 270 },\r\n"
					+ "        \r\n"
					+ "        \"facing=east,shape=inner_left,half=bottom\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_inner\", \"y\": 270 },\r\n"
					+ "        \"facing=west,shape=inner_left,half=bottom\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_inner\", \"y\": 90 },\r\n"
					+ "        \"facing=south,shape=inner_left,half=bottom\": { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_inner\" },\r\n"
					+ "        \"facing=north,shape=inner_left,half=bottom\": { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_inner\", \"y\": 180 },\r\n"
					+ "\r\n"
					+ "\r\n"
					+ "        \"facing=east,shape=straight,half=top\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof\", \"x\": 180 },\r\n"
					+ "        \"facing=west,shape=straight,half=top\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof\", \"x\": 180, \"y\": 180 },\r\n"
					+ "        \"facing=south,shape=straight,half=top\": { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof\", \"x\": 180, \"y\": 90 },\r\n"
					+ "        \"facing=north,shape=straight,half=top\": { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof\", \"x\": 180, \"y\": 270 },\r\n"
					+ "        \r\n"
					+ "        \"facing=east,shape=outer_right,half=top\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_outer\", \"x\": 180, \"y\": 90 },\r\n"
					+ "        \"facing=west,shape=outer_right,half=top\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_outer\", \"x\": 180, \"y\": 270 },\r\n"
					+ "        \"facing=south,shape=outer_right,half=top\": { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_outer\", \"x\": 180, \"y\": 180 },\r\n"
					+ "        \"facing=north,shape=outer_right,half=top\": { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_outer\", \"x\": 180, \"y\": 0 },\r\n"
					+ "        \r\n"
					+ "        \"facing=east,shape=outer_left,half=top\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_outer\", \"x\": 180, \"y\": 0 },\r\n"
					+ "        \"facing=west,shape=outer_left,half=top\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_outer\", \"x\": 180, \"y\": 180 },\r\n"
					+ "        \"facing=south,shape=outer_left,half=top\": { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_outer\", \"x\": 180, \"y\": 90 },\r\n"
					+ "        \"facing=north,shape=outer_left,half=top\": { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_outer\", \"x\": 180, \"y\": 270 },\r\n"
					+ "        \r\n"
					+ "        \"facing=east,shape=inner_right,half=top\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_inner\", \"x\": 180, \"y\": 90 },\r\n"
					+ "        \"facing=west,shape=inner_right,half=top\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_inner\", \"x\": 180, \"y\": 270 },\r\n"
					+ "        \"facing=south,shape=inner_right,half=top\": { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_inner\", \"x\": 180, \"y\": 180 },\r\n"
					+ "        \"facing=north,shape=inner_right,half=top\": { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_inner\", \"x\": 180, \"y\": 0 },\r\n"
					+ "        \r\n"
					+ "        \"facing=east,shape=inner_left,half=top\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_inner\", \"x\": 180, \"y\": 0 },\r\n"
					+ "        \"facing=west,shape=inner_left,half=top\":  { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_inner\", \"x\": 180, \"y\": 180 },\r\n"
					+ "        \"facing=south,shape=inner_left,half=top\": { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_inner\", \"x\": 180, \"y\": 90 },\r\n"
					+ "        \"facing=north,shape=inner_left,half=top\": { \"model\": \""+CompatModid+":block/roof/"+material+"_planks_roof_inner\", \"x\": 180, \"y\": 270 }\r\n"
					+ "    }\r\n"
					+ "}");
		}
			...
			if(!file.exists())
			{
				try
				{
					...
					buffer.write("{\r\n"
							+ "    \"variants\": {           \r\n"
							+ "\r\n"
							+ "        \"part=pyramid\":  { \"model\": \""+CompatModid+":block/top/"+material+"_top_pyramid\" },\r\n"
							+ "		\"part=switched\": { \"model\": \""+CompatModid+":block/top/"+material+"_top_roof\", \"y\": 90},\r\n"
							+ "\r\n"
							+ "        \"part=basic,north=false,east=false,south=false,west=true\":  { \"model\": \""+CompatModid+":block/top/"+material+"_top_roof\", \"y\": 90 },\r\n"
							+ "        \"part=basic,north=false,east=true,south=false,west=true\": { \"model\": \""+CompatModid+":block/top/"+material+"_top_roof\", \"y\": 90},\r\n"
							+ "        \"part=basic,north=false,east=true,south=false,west=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_top_roof\", \"y\": 90},\r\n"
							+ "\r\n"
							+ "        \"part=basic,north=false,east=false,south=true,west=false\":  { \"model\": \""+CompatModid+":block/top/"+material+"_top_roof\"},\r\n"
							+ "        \"part=basic,north=true,east=false,south=false,west=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_top_roof\"},\r\n"
							+ "        \"part=basic,north=false,east=false,south=false,west=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_top_roof\"},\r\n"
							+ "		\"part=basic,north=true,east=false,south=true,west=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_top_roof\"},\r\n"
							+ "\r\n"
							+ "        \"part=end_part,north=true,east=false,south=false,west=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_top_roof_end\"},\r\n"
							+ "        \"part=end_part,north=true,east=false,south=true,west=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_top_roof_end\"},\r\n"
							+ "		\"part=end_part,north=false,east=false,south=false,west=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_top_roof_end\"},\r\n"
							+ "		\r\n"
							+ "		\"part=end_part,north=false,east=true,south=false,west=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_top_roof_end\", \"y\": 90},\r\n"
							+ "		\"part=end_part,north=false,east=true,south=false,west=true\": { \"model\": \""+CompatModid+":block/top/"+material+"_top_roof_end\", \"y\": 90},\r\n"
							+ "		\r\n"
							+ "		\"part=end_part,north=true,east=true,south=true,west=true\": { \"model\": \""+CompatModid+":block/top/"+material+"_four_way_roof\"},\r\n"
							+ "		\"part=basic,north=true,east=true,south=true,west=true\": { \"model\": \""+CompatModid+":block/top/"+material+"_four_way_roof\"},\r\n"
							+ "        \"part=end_part,north=false,east=false,south=true,west=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_top_roof_end\"},\r\n"
							+ "		\"part=end_part,north=false,east=false,south=false,west=true\": { \"model\": \""+CompatModid+":block/top/"+material+"_top_roof_end\"},\r\n"
							+ "		\r\n"
							+ "        \"part=basic,north=true,west=true,east=false,south=false\":  { \"model\": \""+CompatModid+":block/top/"+material+"_top_outer\" },\r\n"
							+ "        \"part=basic,north=true,east=true,west=false,south=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_top_outer\", \"y\":90},\r\n"
							+ "        \"part=basic,south=true,east=true,west=false,north=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_top_outer\", \"y\":180},\r\n"
							+ "		\"part=basic,south=true,west=true,east=false,north=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_top_outer\", \"y\":270},\r\n"
							+ "\r\n"
							+ "        \"part=end_part,north=true,west=true,east=false,south=false\":  { \"model\": \""+CompatModid+":block/top/"+material+"_top_outer\" },\r\n"
							+ "        \"part=end_part,north=true,east=true,west=false,south=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_top_outer\", \"y\":90},\r\n"
							+ "        \"part=end_part,south=true,east=true,west=false,north=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_top_outer\", \"y\":180},\r\n"
							+ "		\"part=end_part,south=true,west=true,east=false,north=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_top_outer\", \"y\":270},\r\n"
							+ "\r\n"
							+ "        \"part=basic,north=true,east=true,south=false,west=true\":  { \"model\": \""+CompatModid+":block/top/"+material+"_three_way_roof\", \"y\":270 },\r\n"
							+ "        \"part=basic,north=false,east=true,south=true,west=true\": { \"model\": \""+CompatModid+":block/top/"+material+"_three_way_roof\", \"y\":90},\r\n"
							+ "        \"part=basic,north=true,east=true,south=true,west=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_three_way_roof\"},\r\n"
							+ "		\"part=basic,north=true,east=false,south=true,west=true\": { \"model\": \""+CompatModid+":block/top/"+material+"_three_way_roof\", \"y\":180},\r\n"
							+ "\r\n"
							+ "        \"part=end_part,north=true,east=true,south=false,west=true\":  { \"model\": \""+CompatModid+":block/top/"+material+"_three_way_roof\", \"y\":270 },\r\n"
							+ "        \"part=end_part,north=false,east=true,south=true,west=true\": { \"model\": \""+CompatModid+":block/top/"+material+"_three_way_roof\", \"y\":90},\r\n"
							+ "        \"part=end_part,north=true,east=true,south=true,west=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_three_way_roof\"},\r\n"
							+ "		\"part=end_part,north=true,east=false,south=true,west=true\": { \"model\": \""+CompatModid+":block/top/"+material+"_three_way_roof\", \"y\":180}\r\n"
							+ "\r\n"
							+ "\r\n"
							+ "		\r\n"
							+ "		\r\n"
		...
		public static void createModelsBlock(String Location, String TextureLocationFormodid, String material, boolean isStemTexture)
		{
			...
			if(!top_roof_end.exists())
			{
				try
				{
					...
					System.out.println("Le fichier " + top_roof_end + " Vient d'�tre g�n�rer � l'emplacement : " + Location);
				}
				catch (IOException e)
				{
					e.printStackTrace();
			...
			if(!top_roof.exists())
			{
				try
				{
					...
					System.out.println("Le fichier " + top_roof + " Vient d'�tre g�n�rer � l'emplacement : " + Location);
				}
				catch (IOException e)
				{
					e.printStackTrace();
			...
			if(!top_pyramid.exists())
			{
				try
				{
					...
					System.out.println("Le fichier " + top_pyramid + " Vient d'�tre g�n�rer � l'emplacement : " + Location);
				}
				catch (IOException e)
				{
					e.printStackTrace();
			...
			if(!top_outer.exists())
			{
				try
				{
					...
					System.out.println("Le fichier " + top_outer + " Vient d'�tre g�n�rer � l'emplacement : " + Location);
				}
				catch (IOException e)
				{
					e.printStackTrace();
			...
			if(!top_inner.exists())
			{
				try
				{
					...
					System.out.println("Le fichier " + top_inner + " Vient d'�tre g�n�rer � l'emplacement : " + Location);
				}
				catch (IOException e)
				{
					e.printStackTrace();
			...
			if(!four_way_roof.exists())
			{
				try
				{
					...
					System.out.println("Le fichier " + four_way_roof + " Vient d'�tre g�n�rer � l'emplacement : " + Location);
				}
				catch (IOException e)
				{
					e.printStackTrace();
			...
			if(!three_way_roof.exists())
			{
				try
				{
					...
					System.out.println("Le fichier " + three_way_roof + " Vient d'�tre g�n�rer � l'emplacement : " + Location);
				}
				catch (IOException e)
				{
					e.printStackTrace();
			...
			if(!file.exists())
			{
				try
				{
					...
					buffer.write("{\r\n"
							+ "    \"variants\": {           \r\n"
							+ "\r\n"
							+ "        \"part=pyramid\":  { \"model\": \""+CompatModid+":block/top/"+material+"_planks_top_pyramid\" },\r\n"
							+ "		\"part=switched\": { \"model\": \""+CompatModid+":block/top/"+material+"_planks_top_roof\", \"y\": 90},\r\n"
							+ "\r\n"
							+ "        \"part=basic,north=false,east=false,south=false,west=true\":  { \"model\": \""+CompatModid+":block/top/"+material+"_planks_top_roof\", \"y\": 90 },\r\n"
							+ "        \"part=basic,north=false,east=true,south=false,west=true\": { \"model\": \""+CompatModid+":block/top/"+material+"_planks_top_roof\", \"y\": 90},\r\n"
							+ "        \"part=basic,north=false,east=true,south=false,west=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_planks_top_roof\", \"y\": 90},\r\n"
							+ "\r\n"
							+ "        \"part=basic,north=false,east=false,south=true,west=false\":  { \"model\": \""+CompatModid+":block/top/"+material+"_planks_top_roof\"},\r\n"
							+ "        \"part=basic,north=true,east=false,south=false,west=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_planks_top_roof\"},\r\n"
							+ "        \"part=basic,north=false,east=false,south=false,west=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_planks_top_roof\"},\r\n"
							+ "		\"part=basic,north=true,east=false,south=true,west=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_planks_top_roof\"},\r\n"
							+ "\r\n"
							+ "        \"part=end_part,north=true,east=false,south=false,west=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_planks_top_roof_end\"},\r\n"
							+ "        \"part=end_part,north=true,east=false,south=true,west=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_planks_top_roof_end\"},\r\n"
							+ "		\"part=end_part,north=false,east=false,south=false,west=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_planks_top_roof_end\"},\r\n"
							+ "		\r\n"
							+ "		\"part=end_part,north=false,east=true,south=false,west=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_planks_top_roof_end\", \"y\": 90},\r\n"
							+ "		\"part=end_part,north=false,east=true,south=false,west=true\": { \"model\": \""+CompatModid+":block/top/"+material+"_planks_top_roof_end\", \"y\": 90},\r\n"
							+ "		\r\n"
							+ "		\"part=end_part,north=true,east=true,south=true,west=true\": { \"model\": \""+CompatModid+":block/top/"+material+"_planks_four_way_roof\"},\r\n"
							+ "		\"part=basic,north=true,east=true,south=true,west=true\": { \"model\": \""+CompatModid+":block/top/"+material+"_planks_four_way_roof\"},\r\n"
							+ "        \"part=end_part,north=false,east=false,south=true,west=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_planks_top_roof_end\"},\r\n"
							+ "		\"part=end_part,north=false,east=false,south=false,west=true\": { \"model\": \""+CompatModid+":block/top/"+material+"_planks_top_roof_end\"},\r\n"
							+ "		\r\n"
							+ "        \"part=basic,north=true,west=true,east=false,south=false\":  { \"model\": \""+CompatModid+":block/top/"+material+"_planks_top_outer\" },\r\n"
							+ "        \"part=basic,north=true,east=true,west=false,south=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_planks_top_outer\", \"y\":90},\r\n"
							+ "        \"part=basic,south=true,east=true,west=false,north=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_planks_top_outer\", \"y\":180},\r\n"
							+ "		\"part=basic,south=true,west=true,east=false,north=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_planks_top_outer\", \"y\":270},\r\n"
							+ "\r\n"
							+ "        \"part=end_part,north=true,west=true,east=false,south=false\":  { \"model\": \""+CompatModid+":block/top/"+material+"_planks_top_outer\" },\r\n"
							+ "        \"part=end_part,north=true,east=true,west=false,south=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_planks_top_outer\", \"y\":90},\r\n"
							+ "        \"part=end_part,south=true,east=true,west=false,north=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_planks_top_outer\", \"y\":180},\r\n"
							+ "		\"part=end_part,south=true,west=true,east=false,north=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_planks_top_outer\", \"y\":270},\r\n"
							+ "\r\n"
							+ "        \"part=basic,north=true,east=true,south=false,west=true\":  { \"model\": \""+CompatModid+":block/top/"+material+"_planks_three_way_roof\", \"y\":270 },\r\n"
							+ "        \"part=basic,north=false,east=true,south=true,west=true\": { \"model\": \""+CompatModid+":block/top/"+material+"_planks_three_way_roof\", \"y\":90},\r\n"
							+ "        \"part=basic,north=true,east=true,south=true,west=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_planks_three_way_roof\"},\r\n"
							+ "		\"part=basic,north=true,east=false,south=true,west=true\": { \"model\": \""+CompatModid+":block/top/"+material+"_planks_three_way_roof\", \"y\":180},\r\n"
							+ "\r\n"
							+ "        \"part=end_part,north=true,east=true,south=false,west=true\":  { \"model\": \""+CompatModid+":block/top/"+material+"_planks_three_way_roof\", \"y\":270 },\r\n"
							+ "        \"part=end_part,north=false,east=true,south=true,west=true\": { \"model\": \""+CompatModid+":block/top/"+material+"_planks_three_way_roof\", \"y\":90},\r\n"
							+ "        \"part=end_part,north=true,east=true,south=true,west=false\": { \"model\": \""+CompatModid+":block/top/"+material+"_planks_three_way_roof\"},\r\n"
							+ "		\"part=end_part,north=true,east=false,south=true,west=true\": { \"model\": \""+CompatModid+":block/top/"+material+"_planks_three_way_roof\", \"y\":180}\r\n"
							+ "\r\n"
							+ "\r\n"
							+ "		\r\n"
							+ "		\r\n"
			...
			if(!file.exists())
			{
				try
				{
					...
					buffer.write("{\r\n"
							...
							+ "        \r\n"
							+ "        \"facing=east,shape=outer_right,half=bottom\":  { \"model\": \""+CompatModid+":block/lower/"+material+"_upper_lower_outer\", \"y\": 90 },\r\n"
							+ "        \"facing=west,shape=outer_right,half=bottom\":  { \"model\": \""+CompatModid+":block/lower/"+material+"_upper_lower_outer\", \"y\": 270 },\r\n"
							+ "        \"facing=south,shape=outer_right,half=bottom\": { \"model\": \""+CompatModid+":block/lower/"+material+"_upper_lower_outer\", \"y\": 180 },\r\n"
							+ "        \"facing=north,shape=outer_right,half=bottom\": { \"model\": \""+CompatModid+":block/lower/"+material+"_upper_lower_outer\" },\r\n"
							+ "        \r\n"
							+ "        \"facing=east,shape=outer_left,half=bottom\":  { \"model\": \""+CompatModid+":block/lower/"+material+"_upper_lower_outer\" },\r\n"
							+ "        \"facing=west,shape=outer_left,half=bottom\":  { \"model\": \""+CompatModid+":block/lower/"+material+"_upper_lower_outer\", \"y\": 180 },\r\n"
							+ "        \"facing=south,shape=outer_left,half=bottom\": { \"model\": \""+CompatModid+":block/lower/"+material+"_upper_lower_outer\", \"y\": 90 },\r\n"
							+ "        \"facing=north,shape=outer_left,half=bottom\": { \"model\": \""+CompatModid+":block/lower/"+material+"_upper_lower_outer\", \"y\": 270 },\r\n"
							+ "        \r\n"
							...
							+ "        \r\n"
							+ "        \"facing=east,shape=outer_right,half=top\":  { \"model\": \""+CompatModid+":block/lower/"+material+"_upper_lower_outer\", \"x\": 180, \"y\": 0 },\r\n"
							+ "        \"facing=west,shape=outer_right,half=top\":  { \"model\": \""+CompatModid+":block/lower/"+material+"_upper_lower_outer\", \"x\": 180, \"y\": 180 },\r\n"
							+ "        \"facing=south,shape=outer_right,half=top\": { \"model\": \""+CompatModid+":block/lower/"+material+"_upper_lower_outer\", \"x\": 180, \"y\": 90  },\r\n"
							+ "        \"facing=north,shape=outer_right,half=top\": { \"model\": \""+CompatModid+":block/lower/"+material+"_upper_lower_outer\", \"x\": 180, \"y\": 270 },\r\n"
							+ "        \r\n"
							+ "        \"facing=east,shape=outer_left,half=top\":  { \"model\": \""+CompatModid+":block/lower/"+material+"_upper_lower_outer\", \"x\": 180, \"y\": 270 },\r\n"
							+ "        \"facing=west,shape=outer_left,half=top\":  { \"model\": \""+CompatModid+":block/lower/"+material+"_upper_lower_outer\", \"x\": 180, \"y\": 90 },\r\n"
							+ "        \"facing=south,shape=outer_left,half=top\": { \"model\": \""+CompatModid+":block/lower/"+material+"_upper_lower_outer\", \"x\": 180, \"y\": 0 },\r\n"
							+ "        \"facing=north,shape=outer_left,half=top\": { \"model\": \""+CompatModid+":block/lower/"+material+"_upper_lower_outer\", \"x\": 180, \"y\": 180 },\r\n"
							+ "        \r\n"
			...
			if(!file.exists())
			{
				try
				{
					...
					buffer.write("{\r\n"
							...
							+ "        \r\n"
							+ "        \"facing=east,shape=outer_right,half=bottom\":  { \"model\": \""+CompatModid+":block/lower/"+material+"_planks_upper_lower_outer\", \"y\": 90 },\r\n"
							+ "        \"facing=west,shape=outer_right,half=bottom\":  { \"model\": \""+CompatModid+":block/lower/"+material+"_planks_upper_lower_outer\", \"y\": 270 },\r\n"
							+ "        \"facing=south,shape=outer_right,half=bottom\": { \"model\": \""+CompatModid+":block/lower/"+material+"_planks_upper_lower_outer\", \"y\": 180 },\r\n"
							+ "        \"facing=north,shape=outer_right,half=bottom\": { \"model\": \""+CompatModid+":block/lower/"+material+"_planks_upper_lower_outer\" },\r\n"
							+ "        \r\n"
							+ "        \"facing=east,shape=outer_left,half=bottom\":  { \"model\": \""+CompatModid+":block/lower/"+material+"_planks_upper_lower_outer\" },\r\n"
							+ "        \"facing=west,shape=outer_left,half=bottom\":  { \"model\": \""+CompatModid+":block/lower/"+material+"_planks_upper_lower_outer\", \"y\": 180 },\r\n"
							+ "        \"facing=south,shape=outer_left,half=bottom\": { \"model\": \""+CompatModid+":block/lower/"+material+"_planks_upper_lower_outer\", \"y\": 90 },\r\n"
							+ "        \"facing=north,shape=outer_left,half=bottom\": { \"model\": \""+CompatModid+":block/lower/"+material+"_planks_upper_lower_outer\", \"y\": 270 },\r\n"
							+ "        \r\n"
							...
							+ "        \r\n"
							+ "        \"facing=east,shape=outer_right,half=top\":  { \"model\": \""+CompatModid+":block/lower/"+material+"_planks_upper_lower_outer\", \"x\": 180, \"y\": 0 },\r\n"
							+ "        \"facing=west,shape=outer_right,half=top\":  { \"model\": \""+CompatModid+":block/lower/"+material+"_planks_upper_lower_outer\", \"x\": 180, \"y\": 180 },\r\n"
							+ "        \"facing=south,shape=outer_right,half=top\": { \"model\": \""+CompatModid+":block/lower/"+material+"_planks_upper_lower_outer\", \"x\": 180, \"y\": 90  },\r\n"
							+ "        \"facing=north,shape=outer_right,half=top\": { \"model\": \""+CompatModid+":block/lower/"+material+"_planks_upper_lower_outer\", \"x\": 180, \"y\": 270 },\r\n"
							+ "        \r\n"
							+ "        \"facing=east,shape=outer_left,half=top\":  { \"model\": \""+CompatModid+":block/lower/"+material+"_planks_upper_lower_outer\", \"x\": 180, \"y\": 270 },\r\n"
							+ "        \"facing=west,shape=outer_left,half=top\":  { \"model\": \""+CompatModid+":block/lower/"+material+"_planks_upper_lower_outer\", \"x\": 180, \"y\": 90 },\r\n"
							+ "        \"facing=south,shape=outer_left,half=top\": { \"model\": \""+CompatModid+":block/lower/"+material+"_planks_upper_lower_outer\", \"x\": 180, \"y\": 0 },\r\n"
							+ "        \"facing=north,shape=outer_left,half=top\": { \"model\": \""+CompatModid+":block/lower/"+material+"_planks_upper_lower_outer\", \"x\": 180, \"y\": 180 },\r\n"
							+ "        \r\n"
