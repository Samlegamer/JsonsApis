	...
	public static void init(String location, String Modid, List<String> mat, String classBlock)
	{
		...
		if(!file.exists())
		{
			try
			{
				...
				for(String i : mat)
				{
					buffer.write("content.add("+classBlock+"."+i+"_log_bridge_middle);");
					buffer.newLine();
					buffer.write("content.add("+classBlock+"."+"rope_"+i+"_bridge);");
					buffer.newLine();
					buffer.write("content.add("+classBlock+"."+i+"_bridge_pier);");
					buffer.newLine();
					buffer.write("content.add("+classBlock+"."+i+"_log_bridge_stair);");
					buffer.newLine();
					buffer.write("content.add("+classBlock+"."+i+"_rope_bridge_stair);");
					buffer.newLine();
					buffer.write("content.add("+classBlock+"."+i+"_rail_bridge);");
					buffer.newLine();
				}
