...
public class TerraformersMC implements Presetting
{
	...
	public void init(String LOCATION)
	{
		...
		fixSakuraFabric(LOCATION, McwAPI.ClientFolderTypes.MCW_BRIDGES_BLOCK_MODEL_WOOD.getPathList());
		fixSakuraFabric(LOCATION, McwAPI.ClientFolderTypes.MCW_DOORS_BLOCK_MODEL_WOOD.getPathList());
		fixSakuraFabric(LOCATION, McwAPI.ClientFolderTypes.MCW_FENCES_BLOCK_MODEL_WOOD.getPathList());
		fixSakuraFabric(LOCATION, McwAPI.ClientFolderTypes.MCW_FURNITURES_BLOCK_MODEL.getPathList());
		fixSakuraFabric(LOCATION, McwAPI.ClientFolderTypes.MCW_PATHS_BLOCK_MODEL_WOOD.getPathList());
		fixSakuraFabric(LOCATION, McwAPI.ClientFolderTypes.MCW_ROOFS_BLOCK_MODEL_WOOD.getPathList());
		fixSakuraFabric(LOCATION, McwAPI.ClientFolderTypes.MCW_STAIRS_BLOCK_MODEL_WOOD.getPathList());
		fixSakuraFabric(LOCATION, McwAPI.ClientFolderTypes.MCW_TRAPDOORS_BLOCK_MODEL_WOOD.getPathList());
		fixSakuraFabric(LOCATION, McwAPI.ClientFolderTypes.MCW_WINDOWS_BLOCK_MODEL_WOOD.getPathList());
