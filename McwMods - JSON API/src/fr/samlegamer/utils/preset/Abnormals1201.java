...
public class Abnormals1201 implements Presetting
{
	...
	public Abnormals1201()
	{
		this(true, true, true, true, true, true, true, true, true);
	}
	
	public Abnormals1201(boolean activeBridges, boolean activeRoofs, boolean activeFences, boolean activeFurnitures, boolean activeStairs, boolean activePaths, boolean activeDoors, boolean activeTraps, boolean activeWindows)
	{
	...
	public void init(String LOCATION)
	{
		...
		if(activeBridges)
		{
			...
			ModsList.abnormalsWood120(MAT_WOOD, Compatibilities.ATMO_MODID);
			...
			ModsList.abnormalsWood120(MAT_WOOD, Compatibilities.CAVERNCHASMS_MODID);
			txtLocMod = Compatibilities.CAVERNCHASMS_TEXTURES; // "upgrade_aquatic:block";
			ModidOfBaseMod = Compatibilities.CAVERNCHASMS_MODID; //"upgrade_aquatic";
			genRessources(LOCATION, CompatModid, MAT_WOOD, txtLocMod, ModidOfBaseMod, false, Compatibilities.MCW_BRIDGES_MODID, client_wood_bridges, data_bridges);
			MAT_WOOD.clear();
		...
		if(activeFences)
		{
			...
			System.out.println("Start Wood Client");
			ModsList.abnormalsWood120(MAT_WOOD, Compatibilities.ATMO_MODID);
			ModsList.abnormalsLeaves120(LEAVES, Compatibilities.ATMO_MODID);
			txtLocMod = Compatibilities.ATMO_TEXTURES; //"atmospheric:block";
			ModidOfBaseMod = Compatibilities.ATMO_MODID; //"atmospheric";
			...
			ModsList.abnormalsWood120(MAT_WOOD, Compatibilities.AUTUM_MODID);
			ModsList.abnormalsLeaves120(LEAVES, Compatibilities.AUTUM_MODID);
			txtLocMod = Compatibilities.AUTUM_TEXTURES; //"autumnity:block";
			ModidOfBaseMod = Compatibilities.AUTUM_MODID; //"autumnity";
			genRessources(LOCATION, CompatModid, MAT_WOOD, txtLocMod, ModidOfBaseMod, false, Compatibilities.MCW_FENCES_MODID, client_wood_fences, data_fences);
			genHedges(LOCATION, CompatModid, LEAVES, txtLocMod, ModidOfBaseMod, client_wood_fences, data_fences);
			...
			ModsList.abnormalsWood120(MAT_WOOD, Compatibilities.ENVI_MODID);
			ModsList.abnormalsLeaves120(LEAVES, Compatibilities.ENVI_MODID);
			txtLocMod = Compatibilities.ENVI_TEXTURES; //"environmental:block";
			ModidOfBaseMod = Compatibilities.ENVI_MODID; //"environmental";
			genRessources(LOCATION, CompatModid, MAT_WOOD, txtLocMod, ModidOfBaseMod, false, Compatibilities.MCW_FENCES_MODID, client_wood_fences, data_fences);
			genHedges(LOCATION, CompatModid, LEAVES, txtLocMod, ModidOfBaseMod, client_wood_fences, data_fences);
			...
			ModsList.abnormalsWood120(MAT_WOOD, Compatibilities.UAQUA_MODID);
			ModsList.abnormalsLeaves120(LEAVES, Compatibilities.UAQUA_MODID);
			txtLocMod = Compatibilities.UAQUA_TEXTURES; //"upgrade_aquatic:block";
			ModidOfBaseMod = Compatibilities.UAQUA_MODID; //"upgrade_aquatic";
			genRessources(LOCATION, CompatModid, MAT_WOOD, txtLocMod, ModidOfBaseMod, false, Compatibilities.MCW_FENCES_MODID, client_wood_fences, data_fences);
			genHedges(LOCATION, CompatModid, LEAVES, txtLocMod, ModidOfBaseMod, client_wood_fences, data_fences);
		...
		if(activeDoors)
		{
			...
			client_wood_doors.createWoodCustomModelsBlocks(LOCATION, txtLocMod, MAT_WOOD, "poise_planks", "poise_stem", "stripped_poise_stem");
		...
		if(activeTraps)
		{
			...
			client_wood_trapdoors.createWoodCustomModelsBlocks(LOCATION, txtLocMod, MAT_WOOD, "poise_planks", "poise_stem", "stripped_poise_stem");
		...
		if(activeWindows)
		{
			...
			client_wood_windows.createWoodCustomModelsBlocks(LOCATION, txtLocMod, MAT_WOOD, "poise_planks", "poise_stem", "stripped_poise_stem");
